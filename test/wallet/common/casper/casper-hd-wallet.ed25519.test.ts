...
test(("casper-hd-wallet.ed25519.master"), async () => {
  ...
  expect(await wallet.getPublicAddress()).toBe("01a4b2856bfec510abab89753fac1ac0e1112364e7d250545963f135f2a33188ed");
});
...
test(("casper-hd-wallet.ed25519.master.acc0"), async () => {
  ...
  expect(await wallet.getPublicAddress()).toBe("018c8a13df77a28f3445213a0f432fde644acaa215fc72dcdf300d5efaa85d350c");
});