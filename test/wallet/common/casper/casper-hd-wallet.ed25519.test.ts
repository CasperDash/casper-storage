...
test(("casper-hd-wallet.ed25519.master"), async () => {
  let hdWallet = new CasperHDWallet(testSeed01, DEFAULT_COINT_PATH, EncryptionType.Ed25519);
  ...
  expect(await wallet.getRawPublicKey()).toBe("00a4b2856bfec510abab89753fac1ac0e1112364e7d250545963f135f2a33188ed");
  expect(await wallet.getPublicKey()).toBe("01a4b2856bfec510abab89753fac1ac0e1112364e7d250545963f135f2a33188ed");
});

test(("casper-hd-wallet.ed25519.master.acc0"), async () => {
  let hdWallet = new CasperHDWallet(TypeUtils.convertHexStringToArray(testSeed01), DEFAULT_COINT_PATH, EncryptionType.Ed25519);
  ...
  expect(await wallet.getRawPublicKey()).toBe("008c8a13df77a28f3445213a0f432fde644acaa215fc72dcdf300d5efaa85d350c");
  expect(await wallet.getPublicKey()).toBe("018c8a13df77a28f3445213a0f432fde644acaa215fc72dcdf300d5efaa85d350c");
});