...
test(("casper-hd-wallet.secp256k1.master"), async () => {
  ...
  expect(await wallet.getAddress()).toBe("020339a36013301597daef41fbe593a02cc513d0b55527ec2df1050e2e8ff49c85c2");
});
...
test(("casper-hd-wallet.secp256k1.master.acc0"), async () => {
  ...
  expect(await wallet.getAddress()).toBe("02035a784662a4a20a65bf6aab9ae98a6c068a81c52e4b032c0fb5400c706cfccc56");
});